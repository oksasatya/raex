...
@section('content')
    <div class="row">
        <div class="col-xl-10 main-content ps-xl-4 pe-xl-5">
            ...
            <p class="lead">A flexible and extensible content container with multiple variants and options. Read the <a
                    href="https://getbootstrap.com/docs/5.1/components/card/" target="_blank">Official Bootstrap
                    Documentation</a> for a full list of instructions and other options.</p>

            <hr>

            <h4 id="default">Basic Example</h4>
            <p class="mb-3">Below is an example of a basic card with mixed content and a fixed width. Cards have no fixed
            ...
            <div class="example">
                <div class="row">
                    <div class="col-12 col-md-6 col-xl-4">
                        <div class="card">
                            <img src="{{ url('assets/images/others/placeholder.jpg') }}" class="card-img-top"
                                alt="...">
                            <div class="card-body">
            ...
            <p class="mb-3">Cards support a wide variety of content, including images, text, list groups, links, and more.
                Below are examples of what’s supported.</p>
            <h4 id="body">Body</h4>
            <p class="mb-3">The building block of a card is the <code>.card-body</code>. Use it whenever you need a padded
            ...
            <p class="mb-3">Subtitles are used by adding a <code>.card-subtitle</code> to a <code>&lt;h*&gt;</code> tag.
                If the <code>.card-title</code> and the <code>.card-subtitle</code> items are placed in a
                <code>.card-body</code> item, the card title and subtitle are aligned nicely.</p>
            <div class="example">
                <div class="row">
                    <div class="col-12 col-md-6 col-xl-4">
                        <div class="card">
            ...
            <p class="mb-3"><code>.card-img-top</code> places an image to the top of the card. With
                ...
                styled with the standard HTML tags.</p>
            <div class="example">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text mb-3">With supporting text below as a natural lead-in to additional
                                    content.</p>
                                <a href="javascript:;" class="btn btn-primary">Go somewhere</a>
                            </div>
                        </div>
            ...
            <p class="mb-3">Cards assume no specific <code>width</code> to start, so they’ll be 100% wide unless
                        ...
                        <div class="card text-center">
                            <div class="card-header">
                                <ul class="nav nav-tabs card-header-tabs">
                                    ...
                                    <li class="nav-item"><a class="nav-link disabled" href="javascript:;" tabindex="-1"
            ...
            <p class="mb-3">Turn an image into a card background and overlay your card’s text. Depending on the image,
                you may or may not need additional styles or utilities.</p>
            <div class="example">
                <div class="row">
            ...
            <p class="mb-3">Use <a href="https://getbootstrap.com/docs/5.1/utilities/colors/" target="_blank">text
                    color</a> and <a href="https://getbootstrap.com/docs/5.1/utilities/background/"
                    target="_blank">background utilities</a> to change the appearance of a card.</p>
            <div class="example">
                <div class="row">
            ...
            <p class="mb-3">Use card groups to render cards as a single, attached element with equal width and height
                columns. Card groups use <code>display: flex;</code> to achieve their uniform sizing.</p>
            <div class="example">
            ...
            <p class="mb-3">Use the Bootstrap grid system and its <a
                    href="https://getbootstrap.com/docs/5.1/layout/grid/#row-columns"
                    target="_blank"><code>.row-cols</code> classes</a>
                to control how many grid columns (wrapped around your cards) you show per row. For example, here’s
                <code>.row-cols-1</code> laying out the cards on one column,
                and <code>.row-cols-md-2</code> splitting four cards to equal width across multiple rows, from the medium
                breakpoint up.</p>
            <div class="example">
